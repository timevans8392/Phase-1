...
function changeCharHead (damage, banner) {
    ...
    if(charmanderHP < 1) {victory = true}
    getCharBanner()
...
function moveOne () {
    ...
    $("#battleGif").prop("src","https://media.giphy.com/media/oFBnvBcmga4XS/giphy.gif")
...
function moveTwo () {
    console.log("button pressed")
    $("#battleGif").prop("src","https://media.giphy.com/media/3xgR6JaucMaXe/giphy.gif")
    $("#battleGif").css("visibility","visible")
...
function moveThree () {
    console.log("button pressed")
    $("#battleGif").prop("src","https://media.giphy.com/media/7L9FYvnh467YI/giphy.gif")
    $("#battleGif").css("visibility","visible")
...
function moveFour () {
    console.log("button pressed")
    $("#battleGif").prop("src","https://media.giphy.com/media/xzBimPZR9loLS/giphy.gif")
    $("#battleGif").css("visibility","visible")
