var beginBattle = `
<div class="d-flex flex-column " id="battleDisplay">
        <div id="" class="d-flex h-75">
            <div class="w-75 d-flex" id="battleArena">
            ...
            <div class="w-25" id="commandButtons">
                <div class="d-flex">
        ...
        <div id="infoPart" class="" style="height: 125px;">
            <div id="commandLayer" class="">
